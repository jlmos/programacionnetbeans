/* Hacer un programa que defina un Arrraylist de Persona_v3. Añade 5 personas pero que una
de ellas que esté repetida. utilizando converisones entre colecciones (sin iterar sobre el ArrayList
elimina los repetidos, preseervando el orden de los elementos del ArrayList.
...
public class JLMLt15e18 {

    public static void main(String[] args) {

        ArrayList<Persona_v3> fiesta = new ArrayList<>();
        TreeSet<Persona_v3> fiesta2 = new TreeSet<>(fiesta);
